...
async def extract_results(matric, pword, folder):
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                await page.wait_for_selector('div.col-xs-12.col-sm-6', timeout=15000)
                ...
                if not results:
                    print(f"Results not available for student {matric} at the moment")
                    return
            ...
            print(f"Error processing student {matric}: {str(e)}")
